...
/**
 * [PositiveBigInt] wraps an immutable [BigInteger] data which is guaranteed to be positive
 */
data class PositiveBigInt(private val v: BigInteger) {
    companion object {
        /**
         * Creates instance of PositiveInt option from given [BigInteger]
         * @param [value] input data of type [BigInteger]
        ...
        /**
         * predefined instance of [PositiveBigInt] with data of 1
         */
        @JvmField
        val ONE = PositiveBigInt(BigInteger.ONE)

        /**
         * predefined instance of [PositiveBigInt] with data of 10
         */
        @JvmField
        val P10 = PositiveBigInt(BigInteger.TEN)

        /**
         * predefined instance of [PositiveBigInt] with data of 12
         */
        @JvmField
        val P12 = PositiveBigInt(12.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 15
         */
        @JvmField
        val P15 = PositiveBigInt(15.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 24
         */
        @JvmField
        val P24 = PositiveBigInt(24.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 25
         */
        @JvmField
        val P25 = PositiveBigInt(25.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 30
         */
        @JvmField
        val P30 = PositiveBigInt(30.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 100
         */
        @JvmField
        val P100 = PositiveBigInt(100.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 1000
         */
        @JvmField
        val P1000 = PositiveBigInt(1000.toBigInteger())

        /**
         * predefined instance of [PositiveBigInt] with data of 1001
         */
        @JvmField
